    ...
    <footer className="text-white bg-gradient-to-r from-primary to-secondary mt-28">
      <div className="max-w-screen-xl px-4 pt-32 pb-12 mx-auto sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <Link href="/rifas">
            <a
              className="inline-block px-12 py-3 mt-8 text-sm font-medium border rounded-full border-white/25 hover:bg-white hover:text-black"
            >
              Ver rifas
            </a>
          </Link>
        ...
        <div className="pt-12 mt-32 border-t border-white/25 sm:items-center sm:justify-between sm:flex">
          ...
          <div className="flex justify-center mt-6 space-x-6 sm:justify-end sm:mt-0">
            <a className="p-2 border rounded-full border-white/25 hover:opacity-75" href="" target="_blank"
               rel="noreferrer">
